...
export default function useClubData() {
  ...
  async function fetchClubData() {
    try {
      const response = await axios.get(
        "https://nutrigym.onrender.com/api/v1/prod"
      );
  ...
  const DeleteClub = async (clubID) => {
    try {
      ...
      const response = await axios.delete(
        `https://nutrigym.onrender.com/api/v1/prod/` + clubID,
        {
          headers: headers,
        }
      );
  ...
  const columns = [
    ...
    { Header: "Sold", accessor: "sold", align: "center" },
    { Header: "Edit", accessor: "edit", align: "center" },
    { Header: "Delete", accessor: "delete", align: "center" },
  ];

  const rows = clubData.map((club) => ({
    title: <Author name={club.title} />,
    description: <Governorate title={club.description} />,
    quantity: club.quantity,
    price: club.price,
    sold: club.sold,
    edit: <Action clubId={club._id} />,
